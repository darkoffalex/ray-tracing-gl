...
// Не всегда нормаль вершины совпадает с нормалью полигона, в таких случаях тангент нужно ортогонализовать по нормали
...
void main()
{
    ...
    for(int i = 0; i < gl_in.length(); i++)
    {
        ...
        // Собрать TBN матрицу
        // В качестве базисных викторов используется тангент, битангент и нормаль
        // Матрица позволяет перейти из касательного пространства текстуры в мировое

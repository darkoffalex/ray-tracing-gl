...
void main()
{
    ...
    // Осущесталвяем только переход в видовое пространство, данные будут использованы в следующем этапе
    ...
    // Также учитывает матрицу вида (поскольку на этапе трассировки все вычисления идут в пространстве вида)
    vs_out.normalMatrix = mat3(_view) * mat3(transpose(inverse(_model)));

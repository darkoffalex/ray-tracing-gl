...
namespace rtgl
{
     ...
     */
    void GeometryBuffer::setupVertexAttributes()
    {
        // Атрибут "положение"
            ...
            indexCount_(0)
    {
        ...
        if (this->vertexCount_ == 0) throw std::runtime_error("ERROR: Vertex array is empty");
        if (this->indexCount_ == 0) throw std::runtime_error("ERROR: Index array is empty");
     ...
     * @return Число вершин
     */
    GLuint GeometryBuffer::getVertexCount() const
    {
     ...
     */
    GLuint GeometryBuffer::getIndexCount() const
    {
     ...
     * @return Число индексов
     */
    GLuint GeometryBuffer::getVaoId() const
    {
        return this->vaoId_;
    }
}
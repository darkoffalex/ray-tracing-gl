...
namespace rtgl
{
    ...
    SceneElement::SceneElement(const glm::vec3 &position,
            ...
            const glm::vec3 &origin):position_(position),orientation_(orientation),scale_(scale),origin_(origin)
    {
     ...
     */
    SceneElement::SceneElement():position_({}),orientation_({}),scale_({1.0f,1.0f,1.0f}),origin_({})
    {
        this->updateModelMatrix();
        this->updateViewMatrix();
    }
